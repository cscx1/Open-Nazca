"""
Streamlit Web UI for AI Code Breaker
User-friendly interface for uploading and scanning code files.
"""
...
def main():
    ...
    # Main content area
    tab1, tab2, tab3 = st.tabs(["📤 Upload & Scan", "📊 Results", "ℹ️ About"])
    ...
    with tab3:
        ...
        **DLLM CheckMate** helps developers identify and fix security vulnerabilities in 
        ...
        - Identifies potential for malicious instruction injection
        - Suggests safe prompt construction patterns
        
        #### 2. 🔑 Hardcoded Secrets
        - Finds API keys, tokens, and passwords in source code
        - Detects AWS, OpenAI, GitHub, and other credentials
        - Recommends environment variable usage
        
        #### 3. ⚠️ Over-Privileged AI Tools
        - Identifies AI agents with dangerous permissions
        - Detects risky operations (delete, exec, drop, etc.)
        ...
        - **LLM Analysis:** OpenAI GPT-4 / Anthropic Claude
        - **Storage:** Snowflake Data Cloud
        - **UI:** Streamlit
        
        ### 👥 Use Cases
        
        - **Developers:** Scan code before committing
        - **Security Teams:** Audit AI system security
        - **DevOps:** Integrate into CI/CD pipelines
        - **Hackathons:** Quick security assessments
        
        ### 📚 Resources
        
        - [OWASP Top 10 for LLM Applications](https://owasp.org/www-project-top-10-for-large-language-model-applications/)
        - [CWE: Common Weakness Enumeration](https://cwe.mitre.org/)
        - [AI Security Best Practices](https://github.com)
        
        ### ⚖️ Responsible Use
        
        This tool is designed for **defensive security only**. Do not use it to:
        - Generate exploit code
        - Attack or compromise systems
        - Violate terms of service
        
        Always obtain proper authorization before scanning code you don't own.
        
        ---
        
        Made with ❤️ by your hackathon team
        """)
        
        st.info("💡 **Tip:** For best results, enable LLM Analysis to get detailed explanations and fix suggestions!")
