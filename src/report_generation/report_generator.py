...
class ReportGenerator:
    ...
    def generate_markdown_report(
        ...
        md_content = f"""# 🔒 KnightCheck Security Scan Report
...
<head>
    ...
    <title>KnightCheck Security Scan Report</title>
    <style>
        body {{
...
<body>
    <div class="header">
        <h1>🔒 KnightCheck Security Scan Report</h1>
...
"""
        ...
        html_content += """
    <div class="footer">
        <p>Generated by KnightCheck Security Scanner</p>
...
"""
    ...
    def generate_console_summary(self, scan_data: Dict[str, Any], findings: List[Dict[str, Any]]) -> str:
        ...
        output = "\n" + "="*70 + "\n"
        output += "🔒 KnightCheck SECURITY SCAN RESULTS\n"
        output += "="*70 + "\n\n"
